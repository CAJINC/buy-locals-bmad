...
export declare const createRateLimit: (options: RateLimitOptions) => (req: Request, res: Response, next: NextFunction) => Promise<Response<any, Record<string, any>>>;
export declare const authRateLimit: (req: Request, res: Response, next: NextFunction) => Promise<Response<any, Record<string, any>>>;
export declare const registrationRateLimit: (req: Request, res: Response, next: NextFunction) => Promise<Response<any, Record<string, any>>>;
export declare const passwordResetRateLimit: (req: Request, res: Response, next: NextFunction) => Promise<Response<any, Record<string, any>>>;
export declare const generalRateLimit: (req: Request, res: Response, next: NextFunction) => Promise<Response<any, Record<string, any>>>;
export declare class AccountLockout {
    private static readonly LOCKOUT_PREFIX;
    private static readonly ATTEMPT_PREFIX;
    private static readonly MAX_ATTEMPTS;
    private static readonly LOCKOUT_DURATION;
    static recordFailedAttempt(identifier: string): Promise<{
        attempts: number;
        isLocked: boolean;
        lockoutExpires?: Date;
    }>;
    static isAccountLocked(identifier: string): Promise<{
        isLocked: boolean;
        lockoutExpires?: Date;
    }>;
    static clearFailedAttempts(identifier: string): Promise<void>;
    static unlockAccount(identifier: string): Promise<void>;
}
export { redisClient };
