...
export declare const initializeRedis: () => Promise<import("@redis/client").RedisClientType<{
    graph: {
        CONFIG_GET: typeof import("@redis/graph/dist/commands/CONFIG_GET.js");
        configGet: typeof import("@redis/graph/dist/commands/CONFIG_GET.js");
        CONFIG_SET: typeof import("@redis/graph/dist/commands/CONFIG_SET.js");
...
export declare class SessionManager {
    ...
    static blacklistToken(tokenId: string, expirationTime?: number): Promise<void>;
    static isTokenBlacklisted(tokenId: string): Promise<boolean>;
    static storeUserSession(userId: string, sessionData: {
        deviceInfo?: string;
        ipAddress?: string;
        lastActivity: Date;
        loginTime: Date;
    }): Promise<void>;
    static getUserSession(userId: string): Promise<{
        deviceInfo?: string;
        ipAddress?: string;
        lastActivity: Date;
        loginTime: Date;
    } | null>;
    static updateLastActivity(userId: string): Promise<void>;
    static clearUserSession(userId: string): Promise<void>;
