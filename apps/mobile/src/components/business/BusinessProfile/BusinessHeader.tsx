...
import { Box, VStack, HStack, Heading, Icon } from 'native-base';
...
export const BusinessHeader: React.FC<BusinessHeaderProps> = React.memo(
  ({ business, logoImage, showVerification = true }) => {
    return (
      <VStack space={4}>
        ...
        <HStack space={4} alignItems="flex-start">
          {logoImage && (
            <Box>
              ...
              >
                ...
                <Box flex={1} bg="blue.100" alignItems="center" justifyContent="center">
                  <Icon as={MaterialIcons} name="business" size="xl" color="blue.500" />
                </Box>
              </Box>
            </Box>
          )}
          ...
          <VStack flex={1} space={3}>
            ...
            <BusinessCategoryBadges categories={business.categories} maxDisplay={3} />
          </VStack>
        </HStack>
      </VStack>
    );
