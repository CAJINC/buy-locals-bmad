...
- [Buy Locals Fullstack Architecture Document](#table-of-contents)
  ...
  - [Components](./components.md)
    ...
    - [Business Service](./components.md#business-service)
    - [Booking Service](./components.md#booking-service)
    - [Payment Service](./components.md#payment-service)
    - [Review Service](./components.md#review-service)
  ...
  - [External APIs](./external-apis.md)
    ...
    - [Twilio API](./external-apis.md#twilio-api)
    - [AWS Cognito](./external-apis.md#aws-cognito)
  - [Core Workflows](./core-workflows.md)
    - [User Registration and Business Onboarding](./core-workflows.md#user-registration-and-business-onboarding)
    - [Booking and Payment Flow](./core-workflows.md#booking-and-payment-flow)
